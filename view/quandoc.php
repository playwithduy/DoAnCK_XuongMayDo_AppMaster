<?php
// FILE: view/quandoc.php

// Kiểm tra dữ liệu từ Controller
if (!isset($data)) {
    header("Location: ../controllers/QuanDocController.php");
    exit;
}
$user = $data['user'];
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; outline: none; text-decoration: none; }
        ...
        .stat-icon { font-size: 40px; margin-bottom: 15px; display: inline-block; }
        .stat-title { font-size: 1.1rem; font-weight: 700; color: #334155; margin-bottom: 5px; display: block; }
        .stat-desc { font-size: 0.85rem; color: #64748b; display: block; }

        /* Màu sắc hộp */
        .box-blue { border-bottom: 4px solid #3b82f6; }
        .box-blue .stat-icon { color: #3b82f6; background: #eff6ff; width: 80px; height: 80px; line-height: 80px; border-radius: 50%; }
        
        .box-green { border-bottom: 4px solid #10b981; }
        .box-green .stat-icon { color: #10b981; background: #ecfdf5; width: 80px; height: 80px; line-height: 80px; border-radius: 50%; }

        .box-purple { border-bottom: 4px solid #8b5cf6; }
        .box-purple .stat-icon { color: #8b5cf6; background: #f5f3ff; width: 80px; height: 80px; line-height: 80px; border-radius: 50%; }
...
<div class="wrapper">
    <div class="sidebar" id="sidebar">
        ...
        <nav style="flex: 1; padding-top: 10px;">
            ...
            <a href="../controllers/QuanDocController.php" class="nav-link active">
    ...
    <div class="main-content">
        <div class="topbar">
            <div style="display: flex; align-items: center;">
                ...
                <h2 class="page-title">Trang Chủ Quản Đốc</h2>
            </div>
        ...
        <div class="content-body">
            <div class="card">
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div>
                        <h2 style="color: #0f172a; margin-top: 0; font-size: 1.5rem;">Xin chào, <?= htmlspecialchars($user['username']) ?>! 👋</h2>
                        <p style="color: #64748b; margin-bottom: 0;">Chào mừng quay trở lại hệ thống quản lý sản xuất.</p>
                    </div>
                    <div style="text-align: right;">
                        <span style="background: #e0f2fe; color: #0284c7; padding: 5px 12px; border-radius: 20px; font-size: 0.85rem; font-weight: 600;">
                            <i class="fas fa-circle" style="font-size: 8px; vertical-align: middle; margin-right: 5px;"></i> Online
                        </span>
                    </div>
                </div>
                ...
                <p style="font-weight: 700; color: #334155; margin-bottom: 15px; text-transform: uppercase; font-size: 0.85rem; letter-spacing: 0.5px;">
                    <i class="fas fa-rocket"></i> Truy cập nhanh
                </p>

                <div class="dashboard-grid">
                    
                    <a href="../controllers/DonHangController.php" class="stat-box box-blue">
                        <i class="fas fa-file-invoice-dollar stat-icon"></i>
                        <span class="stat-title">Danh Sách Đơn Hàng</span>
                        <span class="stat-desc">Xem đơn hàng mới từ bộ phận Kinh doanh</span>
                    </a>

                    <a href="../controllers/LapKeHoachController.php" class="stat-box box-green">
                        <i class="fas fa-calendar-alt stat-icon"></i>
                        <span class="stat-title">Lập Kế Hoạch SX</span>
                        <span class="stat-desc">Lên lịch trình và chọn dây chuyền may</span>
                    </a>

                    <a href="../controllers/PhanBoController.php" class="stat-box box-purple">
                        <i class="fas fa-dolly stat-icon"></i>
                        <span class="stat-title">Phân Bổ Sản Xuất</span>
                        <span class="stat-desc">Giao lệnh sản xuất cho Xưởng trưởng</span>
                    </a>
